...
List <FoodModel> breakfastList=[
  ...
  FoodModel(image: breakfastImagePath("friedegg"), title: "بيض محمر", description: "بيضة", type: "كربوهيدرات", carbRatio:selectedLang!="en"?arabicNumbers("-"): "-"),
...
List <FoodModel> dinnerList=[
  ...
  FoodModel(image: breakfastImagePath("salad"), title: "سلطة خضراء", description: "طبق متوسط", type: "كربوهيدرات", carbRatio:selectedLang!="en"?arabicNumbers("-"): "-"),
  FoodModel(image: dinnerImagePath("kfc"), title: "KFC", description: "قطعة", type: "كربوهيدرات", carbRatio:selectedLang!="en"?arabicNumbers("15"): "15"),
...
List<FoodModel> nutsList=[
  ...
  FoodModel(image: nutsImagePath("chipsy"), title: "شيبسى", description: "كيس شيبسى وزن 50 جرام", type: "كربوهيدرات", carbRatio:selectedLang!="en"?arabicNumbers("30"): "30"),
  FoodModel(image: nutsImagePath("flamnco"), title: "فلامنكو شوفان-سودانى", description: "وزن 50 جرام", type: "كربوهيدرات", carbRatio:selectedLang!="en"?arabicNumbers("15"): "15"),
  FoodModel(image: nutsImagePath("flamncocheese"), title: "فلامنكو بالجبنة", description: "وزن 50 جرام", type: "كربوهيدرات", carbRatio:selectedLang!="en"?arabicNumbers("40"): "40"),
  FoodModel(image: nutsImagePath("windows"), title: "كيس ويندوز", description: "وزن 50 جرام", type: "كربوهيدرات", carbRatio:selectedLang!="en"?arabicNumbers("40"): "40"),
  FoodModel(image: nutsImagePath("bakerols"), title: "بيك رولز", description: "وزن 50 جرام", type: "كربوهيدرات", carbRatio:selectedLang!="en"?arabicNumbers("30"): "30"),
...
List<FoodModel> superMarketList=[
  ...
  FoodModel(image: supermarketImagePath("16"), title: "بسكويت مكفتيز بالشوفان", description: "حجم 24 جرام - عدد قطعتين", type: "كربوهيدرات", carbRatio:selectedLang!="en"?arabicNumbers("14.7"): "14.7"),
  FoodModel(image: supermarketImagePath("16"), title: "بسكويت مكفتيز بالشوفان", description: "حجم 24 جرام - قطعة واحدة", type: "كربوهيدرات", carbRatio:selectedLang!="en"?arabicNumbers("7.3"): "7.3"),
  FoodModel(image: supermarketImagePath("17"), title: "شيبسى", description: "كيس شيبسى وزن 50 جرام", type: "كربوهيدرات", carbRatio:selectedLang!="en"?arabicNumbers("30"): "30"),
...
List<FoodModel> kfcList=[
  ...
  FoodModel(image: kfcImagePath("5"), title: "بطاطس", description: "باكيت بطاطس", type: "كربوهيدرات", carbRatio:selectedLang!="en"?arabicNumbers("39"): "39"),
...
List<FoodModel> macList=[
  ...
  FoodModel(image: macImagePath("12"), title: "بطاطس ماكدونالدز", description: "باكيت بطاطس", type: "كربوهيدرات", carbRatio:selectedLang!="en"?arabicNumbers("69"): "69"),
  FoodModel(image: macImagePath("13"), title: "ميلك شيك شوكولاتة", description: "كوب", type: "كربوهيدرات", carbRatio:selectedLang!="en"?arabicNumbers("109"): "109"),
  FoodModel(image: macImagePath("14"), title: "ميلك شيك فراولة", description: "كوب", type: "كربوهيدرات", carbRatio:selectedLang!="en"?arabicNumbers("105"): "105"),
  FoodModel(image: macImagePath("15"), title: "ميلك شيك فانيليا", description: "كوب", type: "كربوهيدرات", carbRatio:selectedLang!="en"?arabicNumbers("111"): "111"),
  FoodModel(image: macImagePath("16"), title: "ماك فلورى", description: "كوب", type: "كربوهيدرات", carbRatio:selectedLang!="en"?arabicNumbers("103"): "103"),
  FoodModel(image: macImagePath("17"), title: "صانداى شوكولاتة", description: "كوب", type: "كربوهيدرات", carbRatio:selectedLang!="en"?arabicNumbers("67.5"): "67.5"),
  FoodModel(image: macImagePath("18"), title: "صانداى كاراميل", description: "كوب", type: "كربوهيدرات", carbRatio:selectedLang!="en"?arabicNumbers("94"): "94"),
  FoodModel(image: macImagePath("19"), title: "صانداى فراولة", description: "كوب", type: "كربوهيدرات", carbRatio:selectedLang!="en"?arabicNumbers("88"): "88"),
  FoodModel(image: macImagePath("20"), title: "آيس كريم كون", description: "كون واحد", type: "كربوهيدرات", carbRatio:selectedLang!="en"?arabicNumbers( "41"): "41"),
  FoodModel(image: macImagePath("21"), title: "موكا فرابتشينو", description: "كوب", type: "كربوهيدرات", carbRatio:selectedLang!="en"?arabicNumbers("51"): "51"),
  FoodModel(image: macImagePath("22"), title: "كاراميل فرابتشينو", description: "كوب", type: "كربوهيدرات", carbRatio:selectedLang!="en"?arabicNumbers("54"): "54"),
  FoodModel(image: macImagePath("23"), title: "شيكولاتة فرابتشينو", description: "كوب", type: "كربوهيدرات", carbRatio:selectedLang!="en"?arabicNumbers( "45"): "45"),
  FoodModel(image: macImagePath("24"), title: "كابتشينو", description: "كوب", type: "كربوهيدرات", carbRatio:selectedLang!="en"?arabicNumbers("12"): "12"),
  FoodModel(image: macImagePath("25"), title: "لاتيه", description: "كوب", type: "كربوهيدرات", carbRatio:selectedLang!="en"?arabicNumbers("18"): "18"),
  FoodModel(image: macImagePath("26"), title: "فلات وايت", description: "كوب", type: "كربوهيدرات", carbRatio:selectedLang!="en"?arabicNumbers("13"): "13"),
  FoodModel(image: macImagePath("27"), title: "كاراميل ميكاتو", description: "كوب", type: "كربوهيدرات", carbRatio:selectedLang!="en"?arabicNumbers( "33"): "33"),
